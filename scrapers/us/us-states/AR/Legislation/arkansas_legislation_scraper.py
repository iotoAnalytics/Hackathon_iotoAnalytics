...
def get_urls():
    ...
    odd_years = list(set([year[1:5]
                     for year in years if int(year[1:5]) % 2 == 1]))
    ...
    driver = webdriver.Chrome(
        executable_path=r'C:\\Users\\Avery\\Downloads\\chromedriver_win32\\chromedriver.exe', options=options)
