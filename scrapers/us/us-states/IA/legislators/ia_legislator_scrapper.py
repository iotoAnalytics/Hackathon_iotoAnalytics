...
def get_wiki_url(row):
    wikipage_reps = "https://ballotpedia.org/Iowa_House_of_Representatives"
    wikipage_senate = "https://ballotpedia.org/Iowa_State_Senate"
...
def scrape(dict_item):
    ...
    row.district = str(dict_item['District'])
