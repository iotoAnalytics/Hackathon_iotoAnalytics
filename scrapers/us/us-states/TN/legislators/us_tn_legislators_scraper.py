...
def get_wiki_url(row):
    ...
    wikipage_reps = "https://ballotpedia.org/Tennessee_House_of_Representatives"
    wikipage_senate = "https://ballotpedia.org/Tennessee_State_Senate"
...
def main():
    ...
    leg_df = pd.DataFrame(merged_data)
